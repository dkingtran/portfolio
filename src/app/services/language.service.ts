...
export class LanguageService {
    ...
    private translations: { [key: string]: { en: string; de: string } } = {
        ...
        'testimonials.t3.message': { en: "Working with Dennis in our cohort, his user-focused research and rapid iterations noticeably improved the clarity and usability of our interface. His care for micro-interactions made the UI feel polished and intuitive.", de: 'In unserer Weiterbildung hat Dennis durch nutzerzentrierte Recherche und schnelle Iterationen die Verständlichkeit und Bedienbarkeit unserer Oberfläche spürbar verbessert. Seine Sorgfalt bei Mikro‑Interaktionen lässt die Benutzeroberfläche ausgereift und intuitiv erscheinen.' },
