...
export class LanguageService {
    ...
    private translations: { [key: string]: { en: string; de: string } } = {
        ...
        'about.intro': { en: "Hey there, I'm Dennis! Write some information about yourself that is IT related. Why are you passionate about coding? What is your source of inspiration for improving your programming skills?", de: 'Hallo, ich bin Dennis! Schreibe etwas über dich, das IT-bezogen ist. Warum bist du leidenschaftlich am Programmieren? Was ist deine Inspirationsquelle, um deine Programmierfähigkeiten zu verbessern?' },
        'about.location': { en: 'Where are you based? Would you be open to working remotely or potentially relocating?', de: 'Wo bist du ansässig? Wärst du offen für Remote-Arbeit oder einen möglichen Umzug?' },
        'about.mindset': { en: 'Show that you are open-minded. Are you enthusiastic about learning new technologies and continually improving your skills?', de: 'Zeige, dass du aufgeschlossen bist. Bist du begeistert davon, neue Technologien zu lernen und deine Fähigkeiten kontinuierlich zu verbessern?' },
        'about.approach': { en: 'A brief description of your problem-solving approach. Do you learn from each challenge as you search for the most efficient or elegant solution? You can include some keywords like: analytical thinking, creativity, persistence and collaboration.', de: 'Eine kurze Beschreibung deines Problemlösungsansatzes. Lernst du aus jeder Herausforderung, während du nach der effizientesten oder elegantesten Lösung suchst? Du kannst Schlagwörter wie analytisches Denken, Kreativität, Beharrlichkeit und Zusammenarbeit einbeziehen.' },
        'skills.subtitle': { en: 'Technologies', de: 'Technologien' },
        'skills.title': { en: 'Skill Set', de: 'Fähigkeiten' },
        'skills.intro': { en: 'A short introduction of your skills. Highlight your experience of using different front-end technologies and emphasise your openness to learning and adapting to new technologies. Show how important it is for you to keep up with the rapid changes in web development.', de: 'Eine kurze Einführung zu deinen Fähigkeiten. Hebe deine Erfahrung mit verschiedenen Frontend-Technologien hervor und betone deine Offenheit, neue Technologien zu lernen und dich anzupassen. Zeige, wie wichtig es für dich ist, mit den schnellen Veränderungen in der Webentwicklung Schritt zu halten.' },
        ...
        'projects.title': { en: 'Featured Projects', de: 'Ausgewählte Projekte' },
        ...
        'testimonials.t1.message': { en: "Working with Dennis was a delight — his attention to accessibility and detail lifted our product quality significantly.", de: 'Die Zusammenarbeit mit Dennis war großartig – seine Aufmerksamkeit für Barrierefreiheit und Details hat die Produktqualität deutlich erhöht.' },
        ...
        'testimonials.t3.message': { en: 'He iterates quickly, listens closely to feedback and consistently delivers delightful micro-interactions.', de: 'Er iteriert schnell, nimmt Feedback ernst und liefert konstant gelungene Mikro-Interaktionen.' },
        ...
        'contact.intro': { en: 'Encourage people to contact you and describe what role you are interested in. Show that you will add value to their projects through your work.', de: 'Ermutige Menschen, dich zu kontaktieren und beschreibe, für welche Rolle du dich interessierst. Zeige, dass du ihren Projekten durch deine Arbeit Mehrwert bringst.' },
        ...
        'contact.placeholder.message': { en: 'Hello Alex, I am interested in...', de: 'Hallo Alex, ich interessiere mich für...' },
