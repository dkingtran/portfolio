...
export class LanguageService {
    ...
    private translations: { [key: string]: { en: string; de: string } } = {
        ...
        'projects.proj3.description': { en: 'A business messenger similar to Slack, Discord or WhatsApp. Features real-time chat, channels, direct messages and team collaboration tools.', de: 'Ein Business-Messenger ähnlich wie Slack, Discord oder WhatsApp. Mit Echtzeit-Chat, Channels, Direktnachrichten und Team-Kollaborations-Tools.' },
        ...
        'testimonials.t1.message': { en: "I was fortunate to work with Dennis on a demanding group project at Developer Akademie. He stayed calm, focused and helped keep our team on track for success.", de: 'Ich hatte das Glück, mit Dennis in einem anspruchsvollen Gruppenprojekt an der Developer Akademie zusammenzuarbeiten. Er blieb ruhig, fokussiert und half, unser Team auf Erfolgskurs zu halten.' },
        'testimonials.t2.message': { en: 'Dennis completes his tasks on time and delivers clean, well-structured code. Collaborating with him is a pleasure thanks to his reliable and friendly manner.', de: 'Dennis setzt seine Aufgaben termingerecht um und liefert sauberen, gut strukturierten Code. Die Zusammenarbeit mit ihm ist durch seine zuverlässige und angenehme Art sehr angenehm.' },
        ...
        'testimonials.t1.position': { en: 'Project Collaborator, Training', de: 'Projektmitarbeiter, Weiterbildung' },
        'testimonials.t2.position': { en: 'Project Collaborator, Training', de: 'Projektmitarbeiter, Weiterbildung' },
